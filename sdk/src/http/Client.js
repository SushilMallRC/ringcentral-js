...
var Client = /** @class */ (function (_super) {
     ...
     */
    Client.prototype.makeError = function (e_2) {
        return __awaiter(this, arguments, void 0, function (e, response, request) {
            var _a, _b;
    ...
    Client.prototype.createRequest = function (init) {
        ...
        // Append Query String
        if (init.query) {
            init.url = init.url + (init.url.includes('?') ? '&' : '?') + (0, utils_1.objectToUrlParams)(init.query);
        }
        // Serialize body
        if ((0, is_plain_object_1.default)(init.body) || !init.body) {
            ...
            if (contentType.includes(Client._jsonContentType)) {
                ...
                init.body = (0, utils_1.objectToUrlParams)(init.body);
            }
        }
    ...
    Client.prototype.error = function (response_1) {
        return __awaiter(this, arguments, void 0, function (response, skipOKCheck) {
