...
var Auth = /** @class */ (function () {
    ...
    Auth.prototype.setData = function () {
        return __awaiter(this, arguments, void 0, function (newData) {
            var data, savedData;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        data = _a.sent();
                        savedData = __assign(__assign({}, data), newData);
                        ...
                        return [4 /*yield*/, this._cache.setItem(this._cacheId, savedData)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
