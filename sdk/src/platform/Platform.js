...
exports.LoginUrlDisplay = exports.LoginUrlPrompt = exports.events = void 0;
...
var Platform = /** @class */ (function (_super) {
    ...
    function Platform(_a) {
        ...
        if (enableDiscovery) {
            ...
            _this._discovery = new Discovery_1.default({
                clientId: clientId,
                brandId: brandId,
                cache: _this._cache,
    ...
    Platform.prototype.loginUrlWithDiscovery = function () {
    ...
    Platform.prototype.loginUrl = function (_a) {
        ...
        if (usePKCE) {
            ...
            query.code_challenge = (0, crypto_1.createHash)('sha256')
        ...
        return this.createUrl("".concat(this._authorizeEndpoint, "?").concat((0, utils_1.objectToUrlParams)(query)), { addServer: true });
    };
    /**
     * @return {string}
     */
    Platform.prototype._generateCodeVerifier = function () {
        var codeVerifier = (0, crypto_1.randomBytes)(32);
    ...
    Platform.prototype.parseLoginRedirect = function (url) {
        ...
        var queryString = new URLSearchParams(response);
        if (!queryString) {
            throw new Error('Unable to parse response');
        }
        var error = queryString.get('error_description') || queryString.get('error');
        if (error) {
    ...
    Platform.prototype._getTokenAndDiscoveryUriOnLogin = function (_a) {
        return __awaiter(this, arguments, void 0, function (_b) {
            ...
            var token_uri = _b.token_uri, discovery_uri = _b.discovery_uri;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, utils_2.delay)(this._refreshDelayMs)];
                    case 1:
                        _a.sent();
    ...
    Platform.prototype.inflateRequest = function (request_1) {
    ...
    Platform.prototype.sendRequest = function (request_1) {
        return __awaiter(this, arguments, void 0, function (request, options) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, (0, utils_2.delay)(retryAfter)];
                    case 6:
                        _a.sent();
    ...
    Object.defineProperty(Platform.prototype, "userAgent", {
        get: function () {
...
})(LoginUrlPrompt || (exports.LoginUrlPrompt = LoginUrlPrompt = {}));
var LoginUrlDisplay;
...
})(LoginUrlDisplay || (exports.LoginUrlDisplay = LoginUrlDisplay = {}));
