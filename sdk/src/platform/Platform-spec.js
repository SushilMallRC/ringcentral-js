...
describe('RingCentral.platform.Platform', function () {
        ...
        it('is added with default value', (0, test_1.asyncTest)(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        (0, test_1.expect)(request.headers.get('x-user-agent')).toEqual("RCJSSDK/".concat(Constants_1.version));
                        (0, test_1.expect)(platform.userAgent).toEqual("RCJSSDK/".concat(Constants_1.version));
                        return [2 /*return*/];
                }
            });
        }); }));
        it('is added with app name and version', (0, test_1.asyncTest)(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        (0, test_1.expect)(request.headers.get('x-user-agent')).toContain('TestApp/1.0.0 ');
                        return [2 /*return*/];
                }
            });
        }); }, {
        ...
        it('is added with app name', (0, test_1.asyncTest)(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        (0, test_1.expect)(request.headers.get('x-user-agent')).toContain('TestApp ');
                        return [2 /*return*/];
                }
            });
        }); }, {
        ...
        it('is added with additional user agent', (0, test_1.asyncTest)(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        (0, test_1.expect)(request.headers.get('x-user-agent')).toContain(' (build.1000; rev.149f00000)');
                        return [2 /*return*/];
                }
            });
        }); }, {
        ...
        it('initiates refresh if not authorized', (0, test_1.asyncTest)(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _a.apply(void 0, [(_c.sent()).access_token]).not.toEqual('ACCESS_TOKEN_FROM_REFRESH');
                        return [4 /*yield*/, platform.auth().cancelAccessToken()];
                    case 2:
                        _c.sent();
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, platform.auth().data()];
                    case 4:
                        _b.apply(void 0, [(_c.sent()).access_token]).toEqual('ACCESS_TOKEN_FROM_REFRESH');
                        return [2 /*return*/];
                }
            });
        }); }));
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, platform.auth().data()];
                    case 3:
                        _a.apply(void 0, [(_f.sent()).access_token]).toEqual('ACCESS_TOKEN');
                        _b = test_1.expect;
                        return [4 /*yield*/, platform.auth().accessTokenValid()];
                    case 4:
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, platform.auth().data()];
                    case 6:
                        _d.apply(void 0, [(_f.sent()).expire_time > Date.now() + 30 * 60 * 1000]).toEqual(true);
                        _e = test_1.expect;
                        return [4 /*yield*/, platform.auth().data()];
                    case 7:
                        _e.apply(void 0, [(_f.sent()).refresh_token_expire_time > Date.now() + 6 * 24 * 60 * 60 * 1000]).toEqual(true);
                        return [2 /*return*/];
                }
            });
        }); }));
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, platform.auth().data()];
                    case 3:
                        _a.apply(void 0, [(_c.sent()).access_token]).toEqual('ACCESS_TOKEN');
                        _b = test_1.expect;
                        return [4 /*yield*/, platform.auth().accessTokenValid()];
                    case 4:
                        _b.apply(void 0, [_c.sent()]).toEqual(true);
                        return [2 /*return*/];
                }
            });
        }); }));
        ...
        it('login with code from usePKCE flow without client secret', (0, test_1.asyncTest)(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        authData = _b.sent();
                        (0, test_1.expect)(authData.access_token).toEqual('ACCESS_TOKEN');
                        _a = test_1.expect;
                        return [4 /*yield*/, platform.auth().accessTokenValid()];
                    case 4:
                        _a.apply(void 0, [_b.sent()]).toEqual(true);
                        (0, test_1.expect)(authData.code_verifier.length > 0).toEqual(true);
                        return [2 /*return*/];
                }
            });
        }); }, {
        ...
        it('login with code and code_verifier', (0, test_1.asyncTest)(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        authData = _b.sent();
                        (0, test_1.expect)(authData.code_verifier).toEqual('test_code_verifier');
                        _a = test_1.expect;
                        return [4 /*yield*/, platform.auth().accessTokenValid()];
                    case 3:
                        _a.apply(void 0, [_b.sent()]).toEqual(true);
        ...
        it('login with code and code_verifier with client secret', (0, test_1.asyncTest)(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        (0, test_1.expect)(request.headers.get('authorization')).not.toEqual(null);
                        return [4 /*yield*/, platform.auth().data()];
                    case 2:
                        authData = _b.sent();
                        (0, test_1.expect)(authData.access_token).toEqual('ACCESS_TOKEN');
        ...
        it('login with code without clientSecret', (0, test_1.asyncTest)(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        (0, test_1.expect)(request.headers.get('authorization')).toEqual(null);
                        (0, test_1.expect)(request.originalBody || request.body).toContain('client_id=whatever');
                        return [4 /*yield*/, platform.auth().data()];
                    case 2:
                        authData = _a.sent();
                        (0, test_1.expect)(authData.access_token).toEqual('ACCESS_TOKEN');
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, platform.auth().data()];
                    case 3:
                        _a.apply(void 0, [(_b.sent()).access_token]).toEqual('foo');
                        return [2 /*return*/];
                }
            });
        }); }));
        ...
        it('returns false if refresh failed', (0, test_1.asyncTest)(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        res = _a.sent();
                        (0, test_1.expect)(res).toEqual(false);
                        return [2 /*return*/];
                }
            });
        }); }));
        ...
        it('refreshes token when token was expired', (0, test_1.asyncTest)(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        _c.sent();
                        (0, test_1.expect)(refreshSpy.mock.calls.length === 1).toEqual(true);
                        _b = test_1.expect;
                        return [4 /*yield*/, platform.auth().data()];
                    case 4:
                        _b.apply(void 0, [(_c.sent()).access_token]).toEqual('ACCESS_TOKEN_FROM_REFRESH');
        ...
        it('tries to refresh the token if Platform returns 401 Unauthorized and re-executes the request', (0, test_1.asyncTest)(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        _a.apply(void 0, [_c.sent()]).toEqual(response);
                        _b = test_1.expect;
                        return [4 /*yield*/, platform.auth().data()];
                    case 3:
                        _b.apply(void 0, [(_c.sent()).access_token]).toEqual('ACCESS_TOKEN_FROM_REFRESH');
        ...
        it('handles rate limit 429', (0, test_1.asyncTest)(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        res = _b.sent();
                        (0, test_1.expect)(rateLimitSpy.mock.calls.length === 1).toEqual(true);
                        e = rateLimitSpy.mock.calls[0][0];
                        (0, test_1.expect)(e.message).toEqual('expected');
                        (0, test_1.expect)(e.retryAfter).toEqual(10);
                        _a = test_1.expect;
                        return [4 /*yield*/, res.json()];
                    case 2:
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, test_1.expectThrows)(function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                                ...
                                (0, test_1.expect)(rateLimitSpy.mock.calls.length === 1).toEqual(true);
                                var e = rateLimitSpy.mock.calls[0][0];
                                (0, test_1.expect)(e.message).toEqual('expected');
                                (0, test_1.expect)(e.retryAfter).toEqual(60000);
                                (0, test_1.expect)(err).toEqual(e);
                            })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
        ...
        it('handles error in queued AJAX after unsuccessful refresh when token is killed', (0, test_1.asyncTest)(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        (0, test_1.expect)(errorSpy.mock.calls.length === 1).toEqual(true);
                        (0, test_1.expect)(successSpy.mock.calls.length === 1).toBe(false);
                        return [2 /*return*/];
                }
            });
        }); }));
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, (0, test_1.expectThrows)(function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                                ...
                                (0, test_1.expect)(e.originalMessage).toEqual('Malformed OAuth response');
                            })];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, platform.auth().data()];
                    case 4:
                        _c.apply(void 0, [(_d.sent()).access_token]).toEqual('ACCESS_TOKEN_FROM_REFRESH');
                        (0, test_1.expect)(res[0].increment).toEqual(1);
                        (0, test_1.expect)(res[1].increment).toEqual(2);
                        (0, test_1.expect)(res[2].increment).toEqual(3);
                        return [2 /*return*/];
                }
            });
        }); }));
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, platform.auth().data()];
                    case 3:
                        _a.apply(void 0, [(_d.sent()).access_token]).toEqual('ACCESS_TOKEN_FROM_REFRESH');
                        _b = test_1.expect;
                        return [4 /*yield*/, platform.auth().accessTokenValid()];
                    case 4:
                        ...
                        return [4 /*yield*/, platform.auth().refreshTokenValid()];
                    case 5:
                        _c.apply(void 0, [_d.sent()]).toEqual(true);
                        return [2 /*return*/];
                }
            });
        }); }));
        it('skip auth header when auth data without client secret', (0, test_1.asyncTest)(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        authData = _a.sent();
                        (0, test_1.expect)(authData.access_token).toEqual('ACCESS_TOKEN_FROM_REFRESH');
                        return [2 /*return*/];
                }
            });
        }); }, {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    ...
                                    case 1:
                                        ...
                                        return [4 /*yield*/, res.json()];
                                    case 2:
                                        _a.apply(void 0, [(_b.sent()).foo]).toEqual('bar');
                                        return [2 /*return*/];
                                }
                            });
                        }); };
        ...
        it('send request with user agent option', (0, test_1.asyncTest)(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        (0, test_1.expect)(request.headers.get('x-user-agent')).toContain('TestAgent');
                        return [2 /*return*/];
                }
            });
        }); }));
        ...
        it('builds the URL', (0, test_1.asyncTest)(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        platform = sdk.platform();
                        (0, test_1.expect)(platform.createUrl('/restapi/v1.0/foo')).toEqual('/restapi/v1.0/foo');
                        (0, test_1.expect)(platform.createUrl('/restapi/v1.0/foo', { addServer: true })).toEqual('http://whatever/restapi/v1.0/foo');
                        _a = test_1.expect;
                        return [4 /*yield*/, platform.signUrl(platform.createUrl('/restapi/v1.0/foo', {
                                addServer: true,
                            }))];
                    case 1:
                        _a.apply(void 0, [_e.sent()]).toEqual('http://whatever/restapi/v1.0/foo?access_token=ACCESS_TOKEN');
                        _b = test_1.expect;
                        return [4 /*yield*/, platform.signUrl(platform.createUrl('/restapi/v1.0/foo?bar', {
                                addServer: true,
                            }))];
                    case 2:
                        _b.apply(void 0, [_e.sent()]).toEqual('http://whatever/restapi/v1.0/foo?bar&access_token=ACCESS_TOKEN');
                        _c = test_1.expect;
                        return [4 /*yield*/, platform.signUrl(platform.createUrl('/restapi/v1.0/foo?bar', {
                                addServer: true,
                                addMethod: 'POST',
                    ...
                    case 3:
                        _c.apply(void 0, [_e.sent()]).toEqual('http://whatever/restapi/v1.0/foo?bar&_method=POST&access_token=ACCESS_TOKEN');
                        _d = test_1.expect;
                        return [4 /*yield*/, platform.signUrl(platform.createUrl('/rcvideo/v1/foo?bar', {
                                addServer: true,
                            }))];
                    case 4:
                        _d.apply(void 0, [_e.sent()]).toEqual('http://whatever/rcvideo/v1/foo?bar&access_token=ACCESS_TOKEN');
                        return [2 /*return*/];
                }
            });
        }); }));
    ...
    describe('parseLoginRedirect', function () {
        describe('Authorization Code Flow', function () {
            it('parses url correctly', (0, test_1.asyncTest)(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    platform = sdk.platform();
                    (0, test_1.expect)(platform.parseLoginRedirect('?code=foo')).toEqual({ code: 'foo' });
                    return [2 /*return*/];
                });
            }); }));
        });
        describe('Implicit Grant Flow', function () {
            it('parses url correctly', (0, test_1.asyncTest)(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    platform = sdk.platform();
                    (0, test_1.expect)(platform.parseLoginRedirect('#access_token=foo')).toEqual({ access_token: 'foo' });
                    return [2 /*return*/];
                });
            }); }));
        });
        ...
        it('simple usage', (0, test_1.asyncTest)(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                (0, test_1.expect)(platform.loginUrl({
                    ...
                    display: 'foo',
                    prompt: 'foo',
                })).toEqual('http://whatever/restapi/oauth/authorize?response_type=token&redirect_uri=http%3A%2F%2Ffoo&client_id=whatever&state=foo&brand_id=foo&display=foo&prompt=foo&ui_options=&ui_locales=&localeId=');
                (0, test_1.expect)(platform.loginUrl({
                    implicit: false,
                    state: 'foo',
                    brandId: 'foo',
                    display: 'foo',
                    prompt: 'foo',
                })).toEqual('http://whatever/restapi/oauth/authorize?response_type=code&redirect_uri=http%3A%2F%2Ffoo&client_id=whatever&state=foo&brand_id=foo&display=foo&prompt=foo&ui_options=&ui_locales=&localeId=');
                (0, test_1.expect)(platform.loginUrl({
                    implicit: false,
                })).toEqual('http://whatever/restapi/oauth/authorize?response_type=code&redirect_uri=http%3A%2F%2Ffoo&client_id=whatever&state=&brand_id=&display=&prompt=&ui_options=&ui_locales=&localeId=');
                (0, test_1.expect)(platform.loginUrl({
                    usePKCE: true,
                ...
                })).toEqual('http://whatever/restapi/oauth/authorize?response_type=code&redirect_uri=http%3A%2F%2Ffoo&client_id=whatever&state=&brand_id=&display=&prompt=&ui_options=foo&ui_options=bar&ui_locales=&localeId=&response_hint=baz&response_hint=quux');
                (0, test_1.expect)(platform.loginUrl({
                    implicit: false,
                    uiOptions: 'foo',
                    responseHint: 'bar',
                })).toEqual('http://whatever/restapi/oauth/authorize?response_type=code&redirect_uri=http%3A%2F%2Ffoo&client_id=whatever&state=&brand_id=&display=&prompt=&ui_options=foo&ui_locales=&localeId=&response_hint=bar');
                return [2 /*return*/];
            });
        }); }));
    });
        ...
        it('simple usage', (0, test_1.asyncTest)(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        res = _a.sent();
                        (0, test_1.expect)(res.access_token).toEqual('foo');
                        (0, test_1.expect)(close.mock.calls.length === 1).toEqual(true);
                        (0, test_1.expect)(focus.mock.calls.length === 1).toEqual(true);
                        (0, test_1.expect)(openSpy.mock.calls.length === 1).toEqual(true);
                        return [2 /*return*/];
                }
            });
        }); }));
    ...
    describe('parseLoginRedirect', function () {
        it('parses redirect URIs with hash', (0, test_1.asyncTest)(function (sdk) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                platform = sdk.platform();
                (0, test_1.expect)(platform.parseLoginRedirect('#access_token=foo').access_token).toEqual('foo');
                return [2 /*return*/];
            });
        }); }));
    ...
    describe('discovery initial', function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        (0, test_1.expect)(loginUrl.indexOf(initialDiscoveryData.authApi.authorizationUri)).toEqual(0);
                        (0, test_1.expect)(loginUrl.indexOf('discovery=true') > -1).toEqual(true);
                        _a = test_1.expect;
                        return [4 /*yield*/, platform.discovery().initialData()];
                    case 3:
                        _a.apply(void 0, [(_b.sent()).discoveryApi.defaultExternalUri]).toEqual(initialDiscoveryData.discoveryApi.defaultExternalUri);
                        return [2 /*return*/];
                }
            });
        }); });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 4];
                    case 4:
                        (0, test_1.expect)(error.message).toEqual('Client Id is required for discovery');
                        return [2 /*return*/];
                }
            });
        }); });
        it('should emit initialFetchError error after 3 retry', function () {
            return __awaiter(this, void 0, void 0, function () {
                var platform, requestErrorSpy, e_2, discovery, loginUrlError;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 4:
                            ...
                            (0, test_1.expect)(discovery.initialized).toEqual(false);
                            (0, test_1.expect)(requestErrorSpy.mock.calls.length === 3).toEqual(true);
                            loginUrlError = false;
                            try {
                                platform.loginUrl();
                            }
                            ...
                            (0, test_1.expect)(loginUrlError).toEqual(true);
                            return [2 /*return*/];
                    }
                });
            });
        ...
        it('should fetch initial discovery on loginUrlWithDiscovery', function () { return __awaiter(void 0, void 0, void 0, function () {
            var initialDiscoveryData, platform, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        initialDiscoveryData = (0, test_1.getInitialDiscoveryMockData)();
                    ...
                    case 1:
                        _a.apply(void 0, [(_b.sent()).indexOf(initialDiscoveryData.authApi.authorizationUri)]).toEqual(0);
                        return [2 /*return*/];
                }
            });
        }); });
        ...
        it('should throw error when fetch initial discovery error without cache data on loginUrlWithDiscovery', function () {
            return __awaiter(this, void 0, void 0, function () {
                var initialDiscoveryData, platform, error, e_3;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            initialDiscoveryData = (0, test_1.getInitialDiscoveryMockData)();
                        ...
                        case 6:
                            ...
                            return [3 /*break*/, 7];
                        case 7:
                            (0, test_1.expect)(!!error).toEqual(true);
                            return [2 /*return*/];
                    }
                });
            });
        ...
        it('should fetch external discovery when login with discovery_uri and token_uri', function () { return __awaiter(void 0, void 0, void 0, function () {
            var initialDiscoveryData, externalDiscoveryData, platform, externalData, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        initialDiscoveryData = (0, test_1.getInitialDiscoveryMockData)();
                    ...
                    case 2:
                        ...
                        (0, test_1.expect)(externalData.coreApi.baseUri).toEqual(externalDiscoveryData.coreApi.baseUri);
                        _a = test_1.expect;
        ...
        it('should not be expired when not expireIn in external discovery data', function () { return __awaiter(void 0, void 0, void 0, function () {
            var externalDiscoveryData, initialDiscoveryData, platform, externalData, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        externalDiscoveryData = (0, test_1.getExternalDiscoveryMockData)();
        ...
        it('should fetch external discovery fail with 3 retry', function () {
            return __awaiter(this, void 0, void 0, function () {
                var initialDiscoveryData, platform, clientFetchErrorSpy, hasError, e_4;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            initialDiscoveryData = (0, test_1.getInitialDiscoveryMockData)();
                        ...
                        case 3:
                            ...
                            return [3 /*break*/, 4];
                        case 4:
                            (0, test_1.expect)(hasError).toEqual(true);
                            (0, test_1.expect)(clientFetchErrorSpy.mock.calls.length === 3).toEqual(true);
                            return [2 /*return*/];
                    }
                });
            });
        ...
        it('should fetch discovery if user has logged before discovery enabled', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        data = _a.sent();
                        (0, test_1.expect)(data.increment).toEqual(1);
                        return [2 /*return*/];
                }
            });
        }); });
        ...
        it('should fetch rcv api request successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        data = _a.sent();
                        (0, test_1.expect)(data.id).toEqual(123);
                        return [2 /*return*/];
                }
            });
        }); });
        it('should refresh token successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        (0, test_1.expect)(noErrors).toEqual(true);
                        return [2 /*return*/];
                }
            });
        }); });
        it('should logout successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        initialData = _a.sent();
                        (0, test_1.expect)(initialData.authApi.authorizationUri).toEqual(initialDiscoveryData.authApi.authorizationUri);
                        (0, test_1.expect)(loginUrl.indexOf(initialDiscoveryData.authApi.authorizationUri)).toEqual(0);
                        return [2 /*return*/];
                }
            });
        ...
        it('should trigger refresh external discovery data when Discovery-Required', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        discovery = _a.sent();
                        (0, test_1.expect)(discovery.version).toEqual(externalDiscoveryData.version);
                        return [2 /*return*/];
                }
            });
        }); });
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 5:
                            discovery = _a.sent();
                            (0, test_1.expect)(discovery.version).toEqual('1.0.0');
                            (0, test_1.expect)(platform.discovery().externalRetryCycleScheduled).toEqual(true);
        ...
        it('should save tag in external discovery data', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        externalData = _a.sent();
                        (0, test_1.expect)(externalData.tag).toEqual(discoveryTag);
                        return [2 /*return*/];
                }
            });
        }); });
        it('should send Discovery-Tag header in api request', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        res = _a.sent();
                        (0, test_1.expect)(request.headers.get('discovery-tag')).toEqual(discoveryTag);
                        return [2 /*return*/];
                }
            });
        }); });
        ...
        it('should set auth data successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        authData = _c.sent();
                        (0, test_1.expect)(authData.access_token).toEqual(oldToken.access_token);
                        (0, test_1.expect)(authData.refresh_token).toEqual(oldToken.refresh_token);
                        (0, test_1.expect)(authData.expire_time).toEqual(oldToken.expire_time);
                        (0, test_1.expect)(authData.refresh_token_expire_time).toEqual(oldToken.refresh_token_expire_time);
                        return [2 /*return*/];
                }
            });
        }); });
